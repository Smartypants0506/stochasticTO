...
parser.add_argument("--mesh-size-max", type=float, default=1e-3, help="Max element size in metres (STEP assumed mm)")
...
LOAD_VECTORS = {
    "load_1": (1000000, 0.0, 1000000),
    "load_2": (1000000, 0.0, 1000000),
}
