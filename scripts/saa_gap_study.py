    ...
    if comm.rank == 0:
        ...
        payload = {
            ...
            "interpretation": (
                ...
                "the objective. sigma_optimism_relative is how much smaller "
                "sigma_C looks on the optimizer's own samples than on fresh "
                "ones -- POSITIVE means the design is overfitting its sample "
                "set. run_to_run_sigma_variability_relative is the spread of "
